...
import * as tc_desktopcapture from "@takcast/desktopcapture/render";
setPlugin(plugins, tc_desktopcapture._);
...
import * as tc_webmsocket from "@takcast/webmsocket/render";
setPlugin(plugins, tc_webmsocket._);
